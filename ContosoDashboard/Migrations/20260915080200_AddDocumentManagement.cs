    ...
    public partial class AddDocumentManagement : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 0, new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5411), "IT", "System Administrator", "admin@contoso.com", true, true, "Administrator", null, null, null, 3 },
                    { 2, 0, new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5414), "Engineering", "Camille Nicole", "camille.nicole@contoso.com", true, true, "Project Manager", null, null, null, 2 },
                    { 3, 0, new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5416), "Engineering", "Floris Kregel", "floris.kregel@contoso.com", true, true, "Team Lead", null, null, null, 1 },
                    { 4, 0, new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5418), "Engineering", "Ni Kang", "ni.kang@contoso.com", true, true, "Software Engineer", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Announcements",
                columns: new[] { "AnnouncementId", "Content", "CreatedByUserId", "ExpiryDate", "IsActive", "PublishDate", "Title" },
                values: new object[] { 1, "Welcome to the new ContosoDashboard application. This platform will help you manage your tasks and projects more efficiently.", 1, new DateTime(2026, 10, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5576), true, new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5576), "Welcome to ContosoDashboard" });

            migrationBuilder.InsertData(
                table: "Projects",
                columns: new[] { "ProjectId", "CreatedDate", "Description", "Name", "ProjectManagerId", "StartDate", "Status", "TargetCompletionDate", "UpdatedDate" },
                values: new object[] { 1, new DateTime(2026, 8, 16, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5515), "Internal employee productivity dashboard", "ContosoDashboard Development", 2, new DateTime(2026, 8, 16, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5501), 1, new DateTime(2026, 11, 14, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5508), new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5515) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2026, 8, 16, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5559), 1, "TeamLead", 3 },
                    { 2, new DateTime(2026, 8, 16, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5560), 1, "Developer", 4 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, 2, new DateTime(2026, 8, 16, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5535), "Create entity relationship diagram and database design", new DateTime(2026, 8, 26, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5533), 2, 1, 2, "Design database schema", new DateTime(2026, 8, 26, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5536) },
                    { 2, 4, 2, new DateTime(2026, 8, 21, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5538), "Set up Microsoft Entra ID authentication", new DateTime(2026, 9, 20, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5537), 3, 1, 1, "Implement authentication", new DateTime(2026, 9, 15, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5539) },
                    { 3, 4, 2, new DateTime(2026, 8, 26, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5541), "Design user interface mockups for all main pages", new DateTime(2026, 9, 25, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5540), 1, 1, 0, "Create UI mockups", new DateTime(2026, 8, 26, 8, 1, 59, 950, DateTimeKind.Utc).AddTicks(5542) }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_UploadedByUserId_UploadedDate",
                table: "Documents",
                columns: new[] { "UploadedByUserId", "UploadedDate" });
